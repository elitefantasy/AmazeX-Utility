...
"")
        ...
        self.label_Security = QtWidgets.QLabel(self.scrollAreaWidgetContents_3)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.checkBox_Keepass = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkBox_Keepass.sizePolicy().hasHeightForWidth())
        self.checkBox_Keepass.setSizePolicy(sizePolicy)
        self.checkBox_Keepass.setBaseSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.checkBox_Keepass.setFont(font)
        self.checkBox_Keepass.setStyleSheet("")
        self.checkBox_Keepass.setIconSize(QtCore.QSize(16, 16))
        self.checkBox_Keepass.setTristate(False)
        self.checkBox_Keepass.setObjectName("checkBox_Keepass")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_Security.setText(_translate("MainWindow", "Security"))
        self.checkBox_Keepass.setText(_translate("MainWindow", "Keepass"))
